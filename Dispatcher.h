...
{
public:
    Dispatcher(SWSRRingBuffer<FixMarketUpdate> &ringBuffer, MarketTick &marketTick, BookUpdaters &bookUpdaters, StrategyEngine &strategyEngine) : 
    ...
    void exec();
private:
    SWSRRingBuffer<FixMarketUpdate> &ringBuffer_;
