...
public:
    Updater(L1Buffer &l1buffer, L1Book &l1book, std::size_t size) : buffer_(size), l1buffer_(l1buffer), l1book_(l1book) {}
public:
...
{
public:
    UpdatersList(L1Buffer &l1buffer, L1Book &l1book,std::size_t numupdaters, std::size_t bufferSize);
    void start();
